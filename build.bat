...
if "%1" == "%tst%" SET TEST_SETTING= -DVG_VISOR_BUILD_TESTS=ON
if "%2" == "%tst%" SET TEST_SETTING= -DVG_VISOR_BUILD_TESTS=ON
if "%3" == "%tst%" SET TEST_SETTING= -DVG_VISOR_BUILD_TESTS=ON
if "%4" == "%tst%" SET TEST_SETTING= -DVG_VISOR_BUILD_TESTS=ON

if "%1" == "%ex%" SET EXAMPLE_SETTING= -DVG_VISOR_BUILD_EXAMPLES=ON
if "%2" == "%ex%" SET EXAMPLE_SETTING= -DVG_VISOR_BUILD_EXAMPLES=ON
if "%3" == "%ex%" SET EXAMPLE_SETTING= -DVG_VISOR_BUILD_EXAMPLES=ON
if "%4" == "%ex%" SET EXAMPLE_SETTING= -DVG_VISOR_BUILD_EXAMPLES=ON
